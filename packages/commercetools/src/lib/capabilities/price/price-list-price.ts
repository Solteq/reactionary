import { ListPriceQuerySchema, PriceSchema, success, type PriceListPriceProcedureDefinition } from '@reactionary/core';
...
export const commercetoolsPriceListPrice = commercetoolsProcedure({
  ...
  transform: async (query, context, data) => {
    ...
    return success(parseCommercetoolsPrice(sku!, context.request.languageContext.currencyCode));
  },
}) satisfies PriceListPriceProcedureDefinition<CommercetoolsProcedureContext>;
